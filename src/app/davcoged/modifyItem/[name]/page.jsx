...
export default function description() {  
  ...
  const onSubmit = async (e) => {
    ...
    console.log("file :", file);
      ...
      if(title!=null){data.append("title", title);}else{data.append("title", item?.title);}
      if (price!=null){data.append("price", price);}else{data.append("price", item?.price);}
      if (description!=null){data.append("description", description);}else{data.append("description", item?.description);}
      if (category!=null){data.append("category", category);}else{data.append("category", item?.category);}
      if (subcategory!=null){data.append("subcategory", subcategory);}else{data.append("subcategory", item?.subcategory);}
